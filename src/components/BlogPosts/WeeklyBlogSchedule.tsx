...
// Weekly Blog Schedule for SEO Rankings
export const weeklyBlogSchedule = [
  {
    week: 1,
    ...
    keywords: ["lead generation South Africa", "qualified leads 2025", "marketing leads SA"],
  ...
  },
  {
    ...
    category: "Web Design",
    keywords: ["website conversion SA", "web design South Africa", "website optimization 2025"],
  ...
  },
  {
    ...
    keywords: ["social media strategy SA", "social media marketing 2025", "Facebook marketing SA"],
  ...
  },
  {
    ...
    keywords: ["Google Ads South Africa", "Facebook Ads SA", "PPC advertising 2025"],
    publishDate: "2025-02-24"
  }
];

export default weeklyBlogSchedule;