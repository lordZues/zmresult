      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <a href="#results" className="text-gray-700 hover:text-orange-500 transition-colors font-semibold">Results</a>
            <a href="#process" className="text-gray-700 hover:text-orange-500 transition-colors font-semibold">Process</a>
            <a href="#testimonials" className="text-gray-700 hover:text-orange-500 transition-colors font-semibold">Testimonials</a>
            <a href="#about" className="text-gray-700 hover:text-orange-500 transition-colors font-semibold">About</a>
            <a 
              href="#book-call" 
