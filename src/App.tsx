...
function App() {
  ...
  return (
    <div className="font-sans bg-white min-h-screen">
      <Header />
      <main>
        <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-cyan-500"></div></div>}>
          <Routes>
